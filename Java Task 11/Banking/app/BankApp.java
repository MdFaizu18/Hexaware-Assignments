...
public class BankApp {
    ...
    private static void createAccount(BankServiceProviderImpl bank, Scanner scanner) {
        ...
        while (true) {
            ...
            switch (accChoice) {
                case 1:
                    newAccount = new SavingsAccount(0, customer);
                    break;
                case 2:
                    newAccount = new CurrentAccount(0, customer);
                    break;
                case 3:
            ...
            bank.create_account(customer, newAccount.getAccountNumber(), newAccount.getAccountType(), balance);
